...
# # ------------------------------------------------------------------------------
# # 🚨🚨🚨 CÓDIGO DE EJEMPLO DE OTRO EJERCICIO QUE HICIMOS PARA GUIARNOS 🚨🚨🚨
# # ------------------------------------------------------------------------------
...
#     # ----------------------------------------------------------------------
#     # Nueva ruta estadística
#     # ----------------------------------------------------------------------
#     @http.route('/gestion/estadisticas/socio', auth="public", type='http', methods=['GET'], csrf=False)
#     def estadisticas_socio(self, **kwargs):
#         Socio = request.env['socio'].sudo()

#         total_socios = Socio.search_count([])
#         socios_por_nivel = Socio.read_group(
#             [], ['nivel_membresia'], ['nivel_membresia']
#         )
#         ultimo = Socio.search([], order='fecha_registro desc', limit=1)
#         ultima_fecha = ultimo.fecha_registro if ultimo else None

#         data = {
#            'total_socios': total_socios,
#            'socios_por_nivel': socios_por_nivel,
#            'ultima_fecha_registro': ultima_fecha
#         }
        
#         return http.Response(json.dumps(data, default=str), mimetype='application/json')