...
import com.example.android_loop.view.vistas.Denuncias
...
fun AppNavGraph(navController: NavHostController) {
    ...
    Scaffold(
        ...
        modifier = Modifier.Companion.padding(paddingValues)
            ...
            composable(ROUTES.COMPRA_PARAM,
                listOf(
                    navArgument("productos") { type = NavType }
