...
@Composable
fun SettingsScreen(navController: NavHostController, idioma: String) {
                        ...
                        DropdownMenu(
                            ...
                            idiomas.forEach {
                                DropdownMenuItem(
                                    ...
                                    onClick = {
                                        idioma = it
                                        viewModelSettings.cambiarIdioma(storedToken!!, idioma)
                                        expanded = false
                                    }
                                )
                            }
        ...
        when (dialogTipo) {
            "correo" -> {
                MostrarDialog(
                    ...
                    onConfirm = {
                        viewModelSettings.cambiarCorreo(storedToken!!, email)
                        dialogTipo = null
                    },
            ...
            "passwd" -> {
                MostrarDialog(
                    ...
                    onConfirm = {
                        viewModelSettings.cambiarPasswd(storedToken!!, encriptarPasswd(passwd))
                        dialogTipo = null
                    },
                    onDismiss = { dialogTipo = null },
                    confirmEnabled = true,
            ...
            "mobile" -> {
                MostrarDialog(
                    ...
                    onConfirm = {
                        viewModelSettings.cambiarMobile(storedToken!!, mobile)
                        dialogTipo = null
                    },
                    onDismiss = { dialogTipo = null },
                    confirmEnabled = true,
            ...
            "telephone" -> {
                MostrarDialog(
                    ...
                    onConfirm = {
                        viewModelSettings.cambiarTelephone(storedToken!!, tel)
                        dialogTipo = null
                    },
                    onDismiss = { dialogTipo = null },
                    confirmEnabled = true,
        ...
        if (mostrarDialogConfirmacion) {
            MostrarDialog(
                ...
                onConfirm = {
                    ...
                    navController.navigate("login")
                    viewModelSettings.borrarCuenta(storedToken!!)
                    prefs.edit { putString("token", "") }
...
@Composable
fun MostrarDialog(title: String, header: String, value: String?, onValueChange: ((String) -> Unit)?, onConfirm: () -> Unit, onDismiss: () -> Unit, confirmEnabled: Boolean, accionPeligrosa: Boolean) {
    AlertDialog(
...
fun SettingsScreenPreview() {
    Android_LoopTheme {
        SettingsScreen(navController = rememberNavController(), "Español")
    }
}
